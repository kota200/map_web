...
async function createHisat2Module(moduleArg = {}) {
...
function findWasmBinary() {
  if (Module["locateFile"]) {
    return locateFile("hisat2.wasm");
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL("hisat2.wasm", import.meta.url).href;
}
...
var PThread = {
  ...
  allocateUnusedWorker() {
    ...
    worker = new Worker(new URL("hisat2.mjs", import.meta.url), {
      "type": "module",
...
export default createHisat2Module;
